<div class="left_sidebar">
	<div class="sidebar_widget">
		...
		<ul class="arrows_list1">
			...
			<li><a href="<?= Lang::url('how-to-register.php') ?>" <?= ($CFG->self == 'how-to-register.php') ? 'class="active"' : '' ?>><i class="fa fa-angle-right"></i> <?= Lang::string('how-to-register') ?></a></li>
            ...
            <li><a href="<?= Lang::url('news.php') ?>" <?= ($CFG->self == 'news.php') ? 'class="active"' : '' ?>><i class="fa fa-angle-right"></i> <?= Lang::string('news') ?></a></li>
