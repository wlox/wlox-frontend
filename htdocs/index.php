	    ...
	    <div class="popup">
	    	<div class="contain">
	    		<div class="contain1">
					...
					<div class="starting_in"><i class="fa fa-clock-o fa-2x"></i> <?= Lang::string('pre-time-left') ?>: <span class="time_until"></span><input type="hidden" class="time_until_seconds" value="<?= (strtotime('2014-10-01 12:00:00') * 1000) ?>" /></div>
